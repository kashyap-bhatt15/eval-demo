...
from app import app, _get_openai_api_key
...
class TestApp(unittest.TestCase):
    ...
    def test_llm_endpoint_http_error(self, mock_urlopen, mock_getenv):
        ...
        mock_urlopen.side_effect = urllib.error.HTTPError(
            "https://api.openai.com/v1/chat/completions", 401, "Unauthorized", None, error_response
        )
    ...
    def test_get_openai_api_key_missing(self, mock_getenv):
        ...
        self.assertIn("OPENAI_API_KEY environment variable not set", str(context.exception.detail))
